...
# -- Odin Planner -- #
# ------------------ #
FROM registry.hub.docker.com/lukemathwalker/cargo-chef:latest-rust-1.57-alpine as planner
WORKDIR /data/odin
COPY . .
...
# -- Odin Cacher  -- #
# ------------------ #
FROM registry.hub.docker.com/lukemathwalker/cargo-chef:latest-rust-1.57-alpine as cacher
WORKDIR /data/odin
...
# -- Odin Builder -- #
# ------------------ #
FROM registry.hub.docker.com/library/rust:1.58 as builder
WORKDIR /data/odin
COPY . .
