...
pub fn modding_disclaimer() {
  info!("##########################################################################################################################");
  info!("DISCLAIMER! Modding your server can cause a lot of odin.errors.");
  info!("Please do NOT post issue on the valheim-docker repo based on mod issues.");
  info!("By installing odin.mods, you agree that you will do a root cause analysis to why your server is failing before you make a post.");
