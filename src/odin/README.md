...
| GALE_SYNC_CODE                  | `<unset>`                               | FALSE    | Gale profile sync code; its enabled mods are installed ahead of `MODS`.                                                             |
| GALE_SYNC_CONFIGS               | `false`                                 | FALSE    | Also copy the Gale profile's `BepInEx/config` files over the server's.                                                              |
| GALE_SYNC_URL                   | `https://gale.kesomannen.com/api`       | FALSE    | Gale sync API base URL; override for a self-hosted sync server or tests.                                                            |
