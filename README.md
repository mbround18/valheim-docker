...
| VALHEIMPLUS                | ``                | FALSE    | Requires TYPE as BepInEx as it will not install without BepInEx, this var should have a fixed version to ensure control example version `0.9.16.2` however you always want the newest then use "latest". More versions can be found [here](https://github.com/Grantapher/ValheimPlus)                 |                   |          |                                                                                                                                                                                                                                        |
| VALHEIMPLUS_DLL_URL        | `<nothing>`       | FALSE    | Optional override for a direct link to **ValheimPlus.dll** from a GitHub release. If provided, this bypasses the tag/`latest` lookup. |
| VALHEIMPLUS_CFG_URL        | ``                | FALSE    | Optional override for a direct link to the **valheim_plus.cfg** file from a GitHub release. If omitted, the server may generate defaults on first run. |
| VALPLUS_UPDATE_ON_STARTUP         | `1`               | FALSE    | Optional override for installation of valheimplus, this will over-write of the .dll and .cfg file
...
<table>
  ...
  <tr>
    ...
    <td align="center"><a href="https://github.com/nbusseneau"><img src="https://avatars.githubusercontent.com/u/4659919?v=4?s=100" width="100px;" alt=""/><br /><sub><b>Nicolas Busseneau</b></sub></a><br /><a href="https://github.com/mbround18/valheim-docker/commits?author=nbusseneau" title="Documentation">📖</a> <a href="#infra-nbusseneau" title="Infrastructure (Hosting, Build-Tools, etc)">🚇</a> <a href="https://github.com/mbround18/valheim-docker/commits?author=nbusseneau" title="Code">💻</a></td>
  </tr>
</table>
